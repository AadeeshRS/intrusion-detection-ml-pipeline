...
from src.utils.main_utils.utils import load_object, save_object, load_numpy_array_data
...
class ModelTrainer:
    ...
    def train_model(self, X_train, y_train, X_test, y_test):
        try:
            ...
            print(f"Best Model Accuracy Score: {best_model_score:.4f}")
            print(f"{'*'*60}\n")
            ...
            preprocessor = load_object(
                self.data_transformation_artifcat.transformed_object_file_path
            )
            ...
            model_trainer_artifact = ModelTrainerArtifact(
                ...
                train_metric_artifcat=classification_train_metric,
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            train_file_path = (
                self.data_transformation_artifcat.transformed_train_file_path
            )
            test_file_path = (
                self.data_transformation_artifcat.transformed_test_file_path
            )
